  ...
  if (collectBtn) {
    collectBtn.addEventListener("click", () => {
      ...
      if (found.size === plants.length && panelNote) {
        panelNote.innerHTML =
          "<span>you found them all! the forest feels less empty now. take in a deep breath of the fresh air. inhale, exhale. the smell of pine and wet dirt tickles your nose. it's now time to leave quietly.</span>";
      }
